...
/**
 * This is the model class for table "hindi_albums".
 *
 * The followings are the available columns in table 'hindi_albums':
 * @property integer $id
 * @property string $album_name
 * @property integer $no_songs
 * @property string $added_on
 */
class HindiAlbums extends CActiveRecord
{
	/**
	 ...
	 * @return HindiAlbums the static model class
	 */
